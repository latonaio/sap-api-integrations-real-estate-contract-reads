...
type SDC struct {
	...
	RealEstateContract struct {
		...
		TaskListIsHierarchical      interface{} `json:"TaskListIsHierarchical"`
		StrategyPackage             struct {
			...
			Operation                      struct {
				...
				OpPlannedWorkQuantity          interface{} `json:"OpPlannedWorkQuantity"`
				OpWorkQuantityUnit             string      `json:"OpWorkQuantityUnit"`
				NumberOfCapacities             interface{} `json:"NumberOfCapacities"`
				PurchaseOrderQty               interface{} `json:"PurchaseOrderQty"`
				PurchaseOrderQuantityUnit      string      `json:"PurchaseOrderQuantityUnit"`
				OperationStandardDuration      interface{} `json:"OperationStandardDuration"`
				...
				OpExternalProcessingPrice      interface{} `json:"OpExternalProcessingPrice"`
				...
				OperationMaterial              struct {
					...
					BillOfMaterialItemQuantity     interface{} `json:"BillOfMaterialItemQuantity"`
					...
					MatlCompIsMarkedForBackflush   interface{} `json:"MatlCompIsMarkedForBackflush"`
	...
	} `json:"RealEstateContract"`
	APISchema            string   `json:"api_schema"`
	Accepter             []string `json:"accepter"`
	RealEstateContractNo string   `json:"real_estate_contract_no"`
	Deleted              bool     `json:"deleted"`
}
